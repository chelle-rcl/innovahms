...
export default function LandingPage() {
  ...
  return (
    <main className="relative min-h-screen w-full bg-[#0d0c0a] font-sans selection:bg-[#bf9b30]/30 overflow-x-hidden text-[#e5e1d8]">
      ...
      <section className="relative h-screen w-full overflow-hidden">
        ...
        {/* --- ACCOMMODATIONS SECTION (Left Aligned & Compact) --- */}
          ...
          <div className="flex flex-col md:flex-row md:items-end justify-between gap-8 mb-12">
            ...
            >
              ...
              <p className="text-gray-400 text-sm md:text-base font-light leading-relaxed max-w-lg">
                Each room is a sanctuary of comfort and innovation, crafted for the modern traveler. Explore our curated selection of high-tech living spaces.
              </p>
            </motion.div>
  ...
  {/* --- FACILITIES / AMENITIES SECTION (Optimized for Screen Fit) --- */}
<section id="suites" className="relative pt-8 pb-16 px-6 bg-[#0d0c0a] max-w-7xl mx-auto overflow-hidden scroll-mt-24">
  ...
  {/* GRID LAYOUT: Left (Dominant) | Right (Ultra-Slim & Small) */}
  <div className="grid grid-cols-1 lg:grid-cols-12 gap-4">
    
   {/* HIGHLIGHT BOX (KALIWA - NGAYON MAY SPECS NA) */}
<motion.div 
  initial={{ opacity: 0, scale: 0.98 }}
  whileInView={{ opacity: 1, scale: 1 }}
  viewport={{ once: true }}
  className="lg:col-span-8 relative group overflow-hidden rounded-xl border border-white/5 bg-[#14130f] flex flex-col h-[580px]"
>
  {/* Image Section - Pinaliit ang height para magkasya ang text sa baba */}
  ...
  {/* Content Section (Ang "Imperial Sanctum" details) */}
  <div className="p-6 flex flex-col justify-between flex-grow">
    ...
    {/* SIDE CARDS (KANAN - PAYAT, MALIIT, NO OVERFLOW) */}
